...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            <form action="{{ route('admin.formations.update', $formation) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input type="text" name="title" id="title" value="{{ old('title', $formation->title) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="category" id="category" value="{{ old('category', $formation->category) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="diploma" id="diploma" value="{{ old('diploma', $formation->diploma) }}" required
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="4" required
                        class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 @error('description') border-red-500 @enderror">{{ old('description', $formation->description) }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="duration" id="duration" value="{{ old('duration', $formation->duration) }}" required
                ...
                <div>
                    ...
                    <textarea name="requirements" id="requirements" rows="3" required
                        class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 @error('requirements') border-red-500 @enderror">{{ old('requirements', $formation->requirements) }}</textarea>
                    @error('requirements')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <div id="career-opportunities-container" class="space-y-2">
                        @foreach(old('career_opportunities', $formation->career_opportunities ?? []) as $opportunity)
                            <div class="flex space-x-2">
                                <input type="text" name="career_opportunities[]" required value="{{ $opportunity }}"
                ...
                <div>
                    ...
                    @if($formation->image)
                        <div class="mb-2">
                            <img src="{{ asset('storage/' . $formation->image) }}" alt="Image actuelle" class="w-32 h-32 object-cover rounded-md">
                        </div>
                    @endif
