...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-gray-900">Créer une actualité</h1>
        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            <form action="{{ route('admin.actualites.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
